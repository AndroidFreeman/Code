...
class _NotificationsPageState extends State<NotificationsPage> {
  ...
  List<dynamic> _targetStudentsForNotification(
  ...
  Future<void> _showReadDetails(Map<String, dynamic> notification) async {
    ...
    final List<dynamic> targetStudents = _targetStudentsForNotification(notification);

    // Get unique classes for filtering
    final Set<String> classes = targetStudents
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          '${item['readCount'] ?? 0} / ${item['totalCount'] ?? 0}',
...
class _ReadDetailsModalState extends State<_ReadDetailsModal> {
  ...
  void _applyFilter() {
    _filteredStudents = widget.targetStudents.where((s) {
        ...
        children: [
          ...
          TextField(
            decoration: InputDecoration(
              ...
              filled: true,
              fillColor:
                  widget.cs.surfaceContainerHighest.withValues(alpha: 77),
            ...
            child: _filteredStudents.isEmpty
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (ctx, idx) {
                      ...
                      final status = widget.userStatus[studentId];

                      Color iconColor =
                          widget.cs.onSurface.withValues(alpha: 0.3);
                      ...
                      return ListTile(
                        ...
                        title: Text(
                            ...
                            style: TextStyle(
                              color: status == null
                                  ? widget.cs.onSurface.withValues(alpha: 0.5)
                                  : widget.cs.onSurface,
                            )),
                        subtitle:
                            Text(widget.classNameMap[classCode] ?? classCode),
                        trailing: Icon(iconData, color: iconColor, size: 24),
                      );
                    },
                  ),
          ),
