...
content = re.sub(r'static Future<List<String>> getTeacherClasses\(
      String dataDir, String profileId\) async \{', r'static Future<List<String>> getTeacherClasses(\n      String dataDir, String profileId, {String? nativeLibDir}) async {', content)
...
content = re.sub(r'static Future<void> addTeacherClass\(
      String dataDir, String profileId, String newClass\) async \{', r'static Future<void> addTeacherClass(\n      String dataDir, String profileId, String newClass, {String? nativeLibDir}) async {', content)
content = re.sub(r'static Future<void> removeTeacherClass\(
      String dataDir, String profileId, String classCode\) async \{', r'static Future<void> removeTeacherClass(\n      String dataDir, String profileId, String classCode, {String? nativeLibDir}) async {', content)
